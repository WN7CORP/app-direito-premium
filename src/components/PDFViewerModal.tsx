      ...
      <DialogContent className="max-w-full w-full h-screen max-h-screen p-0 m-0 rounded-none border-0">
        <div className={`flex flex-col h-full ${getReadingModeStyles()}`}>
                ...
                <>
                  ...
                  <div className="hidden md:flex gap-1">
                    {[60, 80, 100].map((width) => (
                      <Button
                        key={width}
                        onClick={() => setTextWidth(width as TextWidth)}
                        variant={textWidth === width ? "default" : "outline"}
                        size="sm"
                        className="px-2"
                      >
                        {width}%
                  ...
                  {bookmarks.length > 0 && (
                    <Sheet>
                      <SheetTrigger asChild>
                        <Button variant="outline" size="sm" title="Ver marcadores">
          ...
          <div className="flex-1 overflow-hidden relative">
            ...
            {/* Navegação Rápida (Modo Vertical) */}
            {isVerticalMode && !isZenMode && (
